...
class RedisRatings:
    ...
    def add_dataframe(self, dataframe):
        for i, row in dataframe.reset_index().iterrows():
            self.redis.rpush(self.list_name, row.to_json(orient="index"))

    def add_rating(self, rating):
        self.redis.rpush(self.list_name, rating)

    def delete_all(self):
        # self.redis_.delete(self.list_name)
        self.redis.flushall()
...
if __name__ == '__main__':
    ...
    r.add_rating('{"user_id": 755,"movie_id": 3,"rating": 1,"genre_Adventure": null,"genre_Comedy": 1,"genre_Drama": null,"genre_Fantasy": null,"genre_Mystery": null,"genre_Romance": 1,"genre_Sci-Fi": null,"genre_Thriller": null,"genre_War": null}')
