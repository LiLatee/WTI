...
class CassRatings:
    ...
    def create_table(self):
        ...
        user_id int, movie_id int, rating int, genre_Action int, genre_Adventure int, 
    ...
    def push_data_table(self, rating_string_as_dict):
        ...
        INSERT INTO """ + self.keyspace + """.""" + self.table + """ (user_id, movie_id, rating, genre_Action, genre_Adventure, 
...
if __name__ == "__main__":
    ...
    rating_dict = '''{"user_id": 7556, "movie_id": 3, "rating": 1, "genre_Adventure": null, "genre_comedy": 1, "genre_drama": 0,
